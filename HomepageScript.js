...
$(function(){
  $('img').on("click",function(){
    var url;
    if ($(this).attr('id') == 'homePoster1')
      url = "Team1.html";
    else if ($(this).attr('id') == 'homePoster4')
      url = "Team4.html";
    else if ($(this).attr('id') == 'homePoster5')
      url = "Team5.html";
    else if ($(this).attr('id') == 'homePoster6')
      url = "Team6.html";
    else if ($(this).attr('id') == 'homePoster8')
      url = "Team8.html";
    else if ($(this).attr('id') == 'homePoster11')
      url = "Team11.html";
    else if ($(this).attr('id') == 'homePoster13')
      url = "Team13.html";
    $('#majorContent').load(url);
  });
});
